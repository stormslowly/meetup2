...
function _SetTime(tt) {
    ...
    document.all._contents.style.left = tleft + "px";
    document.all._contents.style.width = "500px";
    document.all._contents.style.visibility = "visible";
}

function _select() {
    _fieldname.value = document.all._hour.value + ":" + document.all._minute.value + ":00";
